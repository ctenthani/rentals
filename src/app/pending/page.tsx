    ...
    if (t.email && data?.payment_id) {
      await supabase.functions.invoke("send-email", {
        body: {
          ...
          html: `<p>Hello ${t.name},</p>
<p>Your rent payment has been confirmed.</p>
<p><a href="https://rentozi.netlify.app/receipt?id=${data.payment_id}">View / print receipt</a></p>
<p>Thank you.<br/>Rentozi Rentals</p>`,
          text: `Hello ${t.name}, your payment was confirmed. Receipt: https://rentozi.netlify.app/receipt?id=${data.payment_id}`,
        },
      });
    }
    await load();
